...
//Buffer nuevo de cinco bytes de longitud que almacene únicamente caracteres ASCII (el caracter a)
...
//lectura de un byte que no está definido (rango mayor al rango del buffer)
...
//buffer de string leido como string
console.log(stringBufer.toString());
//buffer de caracteres leido como string
