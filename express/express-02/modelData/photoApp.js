...
(function () {
   ...
   comments.forEach(function (comment) {
      ...
      })[0]; //sólo una coincidencia. devuelve el contenido de la coincidencia dentro de la matriz
   ...
   if (typeof exports !== 'undefined') {
      // Estamos siendo cargados por el cargador de módulos de Node.js ('require') así que usamos su módulo
      // convenciones de devolución del objeto en exportaciones.
      exports.cs142models = cs142models;
   } else {
      // No estamos en el cargador de módulos de Node.js así que asumimos que estamos siendo cargados
      // por el navegador en el DOM.
