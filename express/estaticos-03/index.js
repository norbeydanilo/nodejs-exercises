...
//Middleware
//__dirname hace alusion a la ruta configurada de manera dinamica tomara la ruta index.html
...
//Middleware para buscaflores
app.use(express.static(__dirname + "/public/buscaflores.html"));
